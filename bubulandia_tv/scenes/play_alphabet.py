"""TODO: Implement alphabet pick-the-letter mini-game."""
...
class PlayAlphabetScene(scene.Scene):
    """Placeholder scene describing the upcoming alphabet activity."""
    ...
    def __init__(self, manager: scene.SceneManager) -> None:
        ...
        self.message = "¡Muy pronto podrás elegir la letra correcta!"
    ...
    def go_next(self) -> None:
        self.manager.go_to("play_numbers")

    def go_learn(self) -> None:
        self.manager.go_to("learn", start_module="alphabet")

    def repeat_message(self) -> None:
        self.manager.context.audio.speak("El juego de letras llegará muy pronto")
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        ui.draw_text(surface, "Abecedario - Próximamente", title_font, theme.THEME.text_primary, (960, 200))
        ...
        ui.draw_text(surface, "Practica el abecedario en modo aprender", hint_font, theme.THEME.text_secondary, (960, 440))
        for button in self.buttons.values():
            button.draw(surface)
